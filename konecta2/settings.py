...
PROJECT_PATH = os.path.dirname("__file__")#COn esto siempre encuentra la direccion de nuestro poyecto
...
SECRET_KEY = '&amp;uxm)pc8w%3*rnobi(i1qs2#lm80mm=2yfb1xu*f^h5^06rwny'
...
TEMPLATE_DIRS = (
    os.path.join(PROJECT_PATH, 'konecta2/templates'),
